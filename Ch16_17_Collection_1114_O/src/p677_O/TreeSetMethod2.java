...
public class TreeSetMethod2 {
	...
	public static void main(String[] args) {
		...
		treeSet2.add(str1);
		treeSet2.add(str2);
		System.out.println(treeSet2.toString()); // 유니코드
