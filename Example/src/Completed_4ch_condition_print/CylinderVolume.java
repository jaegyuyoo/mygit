...
public class CylinderVolume {
	...
	public static void main(String[] args) {
		...
		} else if (radius == 0 && lenght == 0) { // 둘다 0인경우 
			System.out.println("0 이외 수를 입력해주세요");
		} else if (radius < 0 && lenght > 0) { // 반지름이 음수인 경우
			System.out.println("반지름이 음수입니다. 양의 반지름을 입력해주세요");
		} else if (radius > 0 && lenght < 0) { // 길이가 음수인 경우
			System.out.println("길이가 음수입니다. 양의 길이를 입력해주세요");
		} else { // 둘 다음수인 경우
			System.out.println("반지름, 길이 모두 음수입니다. 모두 양수로 입력해주세요");
		}
	}
