package p795_sec02_fileinputoutputstream.EX05_FileOutputStream_2_O;
...
public class FileOutputStream_2 {
	...
	public static void main(String[] args) throws IOException{
		...
		// 1. 입력파일 생성
		File outFile = new File("src/sec02_fileinputoutputstream/FileInput-Stream2.txt");
		...
		// 3. n-byte 단위 쓰기(byte[]의 offset부터 length개의 byte 데이터쓰기)
